...
public class TopicServiceImpl implements TopicService {
    ...
    public ResponseTopic<TopicDTO> addTopic(TopicDTO topicDTO) throws FileNotFoundException {
...
//            if ( (topicDTO.getName()==(topic.getName())) || (topicDTO.getId()==(topic.getId())))
            if((topicDTO.getId()==(topic.getId()))){
                throw new ResponseStatusException(HttpStatus.FOUND, "Topic Already present!");
            }
        }
...
//            String name = topicDTO.getName();
            ...
            fp.createNewFile();
            FileWriter fwrite = new FileWriter(Path + name+".txt");
